...
therefore those files as used in the publication are included in the precomputed folder.
...
echo Bavaria Genus 2014 $(echo "100 * $COMMON_NEW/$SPECIES_BAVARIA" | bc -l)%
echo Bavaria Genus 2011 $(echo "100 * $COMMON_OLD/$SPECIES_BAVARIA" | bc -l)%
#+END_SRC

| Bavaria | Species | 2014 | 80.098684% |
| Bavaria | Species | 2011 | 53.179824% |
| Bavaria | Genus   | 2014 | 34.100877% |
| Bavaria | Genus   | 2011 | 28.289473% |

*** TODO Number of genera per order (Supplemental File 2)
